...
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_TodoItem;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_Priority;
typedef struct {
  libkn_KNativePtr pinned;
...
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_TodoItem_Companion;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_Priority_LOW;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_Priority_MEDIUM;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_Priority_HIGH;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_Priority_URGENT;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_TodoFilter;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_TodoFilter_ALL;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_TodoFilter_ACTIVE;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_TodoFilter_COMPLETED;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_data_TodoFilter_HIGH_PRIORITY;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_todo_viewmodel_TodoViewModel;
typedef struct {
  libkn_KNativePtr pinned;
    ...
    struct {
            ...
            struct {
              struct {
                struct {
                  ...
                  libkn_kref_com_tencent_todo_data_TodoItem_Companion (*_instance)();
                  libkn_kref_com_tencent_todo_data_TodoItem (*create)(libkn_kref_com_tencent_todo_data_TodoItem_Companion thiz, const char* title, const char* description, libkn_kref_com_tencent_todo_data_Priority priority, libkn_kref_kotlin_Long dueDate, libkn_kref_kotlin_collections_List tags);
                } Companion;
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_todo_data_TodoItem (*TodoItem)(const char* id, const char* title, const char* description, libkn_KBoolean isCompleted, libkn_kref_com_tencent_todo_data_Priority priority, libkn_KLong createdAt, libkn_kref_kotlin_Long completedAt, libkn_kref_kotlin_Long dueDate, libkn_kref_kotlin_collections_List tags);
                libkn_kref_kotlin_Long (*get_completedAt)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_KLong (*get_createdAt)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                const char* (*get_description)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_kotlin_Long (*get_dueDate)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                const char* (*get_id)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_KBoolean (*get_isCompleted)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_com_tencent_todo_data_Priority (*get_priority)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_kotlin_collections_List (*get_tags)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                const char* (*get_title)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                const char* (*component1)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                const char* (*component2)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                const char* (*component3)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_KBoolean (*component4)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_com_tencent_todo_data_Priority (*component5)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_KLong (*component6)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_kotlin_Long (*component7)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_kotlin_Long (*component8)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_kotlin_collections_List (*component9)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                libkn_kref_com_tencent_todo_data_TodoItem (*copy)(libkn_kref_com_tencent_todo_data_TodoItem thiz, const char* id, const char* title, const char* description, libkn_KBoolean isCompleted, libkn_kref_com_tencent_todo_data_Priority priority, libkn_KLong createdAt, libkn_kref_kotlin_Long completedAt, libkn_kref_kotlin_Long dueDate, libkn_kref_kotlin_collections_List tags);
                libkn_KBoolean (*equals)(libkn_kref_com_tencent_todo_data_TodoItem thiz, libkn_kref_kotlin_Any other);
                libkn_KInt (*hashCode)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
                const char* (*toString)(libkn_kref_com_tencent_todo_data_TodoItem thiz);
              } TodoItem;
              struct {
                struct {
                  libkn_kref_com_tencent_todo_data_Priority (*get)(); /* enum entry for LOW. */
                } LOW;
                struct {
                  libkn_kref_com_tencent_todo_data_Priority (*get)(); /* enum entry for MEDIUM. */
                } MEDIUM;
                struct {
                  libkn_kref_com_tencent_todo_data_Priority (*get)(); /* enum entry for HIGH. */
                } HIGH;
                struct {
                  libkn_kref_com_tencent_todo_data_Priority (*get)(); /* enum entry for URGENT. */
                } URGENT;
                libkn_KType* (*_type)(void);
                const char* (*get_color)(libkn_kref_com_tencent_todo_data_Priority thiz);
                const char* (*get_displayName)(libkn_kref_com_tencent_todo_data_Priority thiz);
              } Priority;
              struct {
                struct {
                  libkn_kref_com_tencent_todo_data_TodoFilter (*get)(); /* enum entry for ALL. */
                } ALL;
                struct {
                  libkn_kref_com_tencent_todo_data_TodoFilter (*get)(); /* enum entry for ACTIVE. */
                } ACTIVE;
                struct {
                  libkn_kref_com_tencent_todo_data_TodoFilter (*get)(); /* enum entry for COMPLETED. */
                } COMPLETED;
                struct {
                  libkn_kref_com_tencent_todo_data_TodoFilter (*get)(); /* enum entry for HIGH_PRIORITY. */
                } HIGH_PRIORITY;
                libkn_KType* (*_type)(void);
              } TodoFilter;
              libkn_KInt (*com_tencent_todo_data_TodoItem$stableprop_getter)();
            } data;
            struct {
              libkn_KLong (*getCurrentTimeMillis)();
            } utils;
            struct {
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_todo_viewmodel_TodoViewModel (*TodoViewModel)();
                libkn_KInt (*get_activeCount)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_KInt (*get_completedCount)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_kref_com_tencent_todo_data_TodoFilter (*get_currentFilter)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_KInt (*get_highPriorityCount)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                const char* (*get_searchQuery)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_kref_com_tencent_todo_data_TodoItem (*get_selectedTodo)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_KBoolean (*get_showAddDialog)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_KBoolean (*get_showDetailDialog)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_kref_androidx_compose_runtime_snapshots_SnapshotStateList (*get_todos)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                libkn_KInt (*get_totalCount)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*addTodo)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz, const char* title, const char* description, libkn_kref_com_tencent_todo_data_Priority priority, libkn_kref_kotlin_Long dueDate, libkn_kref_kotlin_collections_List tags);
                void (*clearCompleted)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*deleteTodo)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz, const char* todoId);
                libkn_kref_kotlin_collections_List (*getFilteredTodos)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*hideAddDialog)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*hideDetailDialog)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*markAllAsActive)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*markAllAsCompleted)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*setFilter)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz, libkn_kref_com_tencent_todo_data_TodoFilter filter);
                void (*setSearchQuery)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz, const char* query);
                void (*showAddDialog)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz);
                void (*showDetailDialog)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz, libkn_kref_com_tencent_todo_data_TodoItem todo);
                void (*toggleTodoCompletion)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz, const char* todoId);
                void (*updateTodo)(libkn_kref_com_tencent_todo_viewmodel_TodoViewModel thiz, libkn_kref_com_tencent_todo_data_TodoItem todo);
              } TodoViewModel;
              libkn_KInt (*com_tencent_todo_viewmodel_TodoViewModel$stableprop_getter)();
            } viewmodel;
      ...
      struct {
        struct {
          struct {
            struct {
              libkn_KInt (*todocomposeapp_composeapp_generated_resources_Res$stableprop_getter)();
              libkn_KInt (*todocomposeapp_composeapp_generated_resources_Res_drawable$stableprop_getter)();
              libkn_KInt (*todocomposeapp_composeapp_generated_resources_Res_font$stableprop_getter)();
              libkn_KInt (*todocomposeapp_composeapp_generated_resources_Res_string$stableprop_getter)();
            } resources;
          } generated;
        } composeapp;
      } todocomposeapp;
